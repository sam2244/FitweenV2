          ...
          return Center(
            child: Column(
              children: [
                ...
                SvgPicture.asset('assets/image/page/complete/trophy.svg'),
                const SizedBox(height: 40.0),
                const Text('+302kg 달성 !',
                ...
                SizedBox(
                  ...
                  height: 120.0,
                  child: Card(
                    color: Color(controller.levelUpState ? 0xff54bab9 : 0xfffbf8f1),
                    child: controller.levelUpState ? Lottie.asset(
                      ...
                      children: [
                        Container(
                          ...
                          child: SvgPicture.asset(controller.assets[controller.assetIndex]),
                        ),
                        Expanded(
                          child: Container(
                            padding: const EdgeInsets.all(10.0),
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(controller.titles[controller.assetIndex],
