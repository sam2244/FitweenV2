...
import 'package:fitweenV1/view/page/exercise/main/widget.dart';
...
class ExerciseMainPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<ExercisePresenter>(
          builder: (controller) {
            return Column(
              children: [
                Container(
                        ...
                        Center(
                          child: CircularPercentIndicator(
                            ...
                            percent: (controller.exerciseTimer?.tick ?? .0)
                                % (ExercisePresenter.exerciseTime * 100)
                                / (ExercisePresenter.exerciseTime * 100),
                            progressColor: const Color(0xff54bab9),
                            ...
                            child: SizedBox(
                              ...
                              child: Center(
                                child: SvgPicture.asset(
                                  ExercisePresenter.assets[controller.assetIndex],
                                ),
                              ),
                            ),
                          ),
                ...
                Column(
                  children: [
                    ...
                    const FWDirectButton(
                      onPressed: ExercisePresenter.toExerciseTypeSetting,
                      text: '운동 설정하기',
                    ),
                  ],
                ),
